...
| Admin Rank | Trang quản trị cấp bậc | Thăng, hạ cấp tài khoản, có cấp đặc biệt `👑 Lọ Vương` và `👩‍🦽 Vô Gia Cư` |
| Notifications | Popup thông báo trên menu | Xem ai trả lời bình luận, ai bình luận bài viết, ai thích bài viết, thông báo hệ thống từ admin |
...
- Gửi thông báo hệ thống trong popup chuông thông báo.
...
- Hàm `admin_update_user_rank` để admin cấp tay các bậc đặc biệt như `Lọ Vương`, `Vô Gia Cư` và `Vương Giả` khi RLS chặn cập nhật trực tiếp.
...
- Popup chuông thông báo lấy dữ liệu từ bảng `notifications`; nếu chưa chạy migration Supabase thì popup sẽ báo cần kiểm tra migration.
